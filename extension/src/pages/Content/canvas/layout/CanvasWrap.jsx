...
const CanvasWrap = (props) => {
  ...
  useEffect(() => {
    ...
    const canvas = new fabric.Canvas("canvas-instructionscrafter", {
  ...
  return (
    ...
    >
      <div
        ...
        ref={canvasContainer}
        id="canvas-wrapper-instructionscrafter"
        style={{
          height: "100vh",
          width: "100vw",
          zIndex:
      ...
      >
        <canvas id="canvas-instructionscrafter" ref={canvasRef} className="canvas" />
      </div>
    </div>
  );
};
